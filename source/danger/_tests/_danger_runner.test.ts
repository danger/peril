...
it("exposes specific process env vars via the peril object ", async () => {
  ...
  const perilObj = perilObjectForInstallation(processInstallationSettings, fakeProcess, false)
...
it("allows passing through Peril DSL attributes ", async () => {
  ...
  const perilObj = perilObjectForInstallation(processInstallationSettings, fakeProcess, perilDSL) as any
